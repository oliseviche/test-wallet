  ...
  var Modal = function(element, options) { // element is the is the modal
    ...
    this.open = function() {
      ...
      timer = setTimeout( function() {
        ...
        self.eventHandlers['open'].forEach(function(handler) {
    ...
    this.close = function() {
      ...
      setTimeout( function() {
        ...
        self.eventHandlers['close'].forEach(function(handler) {
           handler.apply(null, args);
        });
      }, this.options.duration);
    };
    ...
    this.addEventListener = function (event, handler) {
      ...
      return function() {
        self.eventHandlers[event] = self.eventHandlers[event].filter(function(h) {
          return h !== handler; 
        });
      }
    };
