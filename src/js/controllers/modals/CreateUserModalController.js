...
export default class CreateUserModalController extends BaseDialogController {
	constructor(modal) {
		super(modal);
	...
	submit() {
		...
		if (this.validateFields(fields)) {
			this.modal.submit(() => ApplicationActions.createUser(Utils.fields2json(fields)));
		}
	}
	cancel() {
		this.modal.cancel();
